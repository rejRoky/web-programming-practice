...
// Keyboard Event
const nnameInput = document.querySelector('#name');
nnameInput.addEventListener('input', e => {
    document.querySelector('.container').append(nnameInput.value);
});
